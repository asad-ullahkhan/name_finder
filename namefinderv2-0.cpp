/*this is namefinderv2.0 with whole new program,less mistakes.
it is improved to unlimited no of letter in names */
...
int ans;             //for no of letters.
    ...
    cout<<"how many letter are there in it : "<<endl;
    cin>> ans;
   ...
   for (int i = 0; i < ans; i++)
   {
    cout<<"which column does your "<< i<< " letter belong : ";
    cin>> col[i];
   }
